...
export default function PropertyGrid() {
  ...
  return (
    ...
    <section className="max-w-7xl mx-auto px-6 md:px-12 py-12">
      <div className="mb-8">
        <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">Discover a World of Possibilities</h2>
        <p className="text-gray-400 text-sm">
          Explore our curated selection of exceptional properties. Each listing offers a unique opportunity to find your perfect home or investment.
        </p>
      </div>
